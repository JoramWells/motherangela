    ...
    <div>
      ...
      >
        ...
        <div className="flex-1">
          <div
            className="p-2 bg-white rounded-lg flex flex-row items-center justify-between"
          >
          ...
          <div
            className="w-1/2 bg-white mt-2 border rounded-lg border-zinc-100"
          >
