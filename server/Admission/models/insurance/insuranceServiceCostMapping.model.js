...
Insurance_service_cost_mapping.belongsTo(InsuranceDetail, { foreignKey: 'insurance_id' });
// InsuranceDetail.hasMany(Insurance_service_cost_mapping, { foreignKey: 'insurance_id' });
